...
const {getPosts,likeCount, createPost, getPost, updatePost, deletePost,likePost, testErrors, getFriendsPostController, findUserByName, findUsersByType } = require('../controllers/dashboard.controller')
