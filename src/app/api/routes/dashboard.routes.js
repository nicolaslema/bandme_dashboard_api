...
const {getPosts,likeCount, createPost, getPost, updatePost, deletePost,likePost, testErrors, getFriendsPostController, findUserByName, findUsersByType, findPosteosByType } = require('../controllers/dashboard.controller')
